...
function mainVideoPlay() {
    ...
    if (mainVideoH == 2) {
        mainVideoM = parseInt(Math.random() * 28);
    }
    else {
        mainVideoM = parseInt(Math.random() * 60);
    }
    mainVideoS = parseInt(Math.random() * 60);
    console.log(mainVideoH, mainVideoM, mainVideoS);
    let mainVideoUrl = "music/sample.mp4#t=0" + mainVideoH + ":" + mainVideoM + ":" + mainVideoS;
