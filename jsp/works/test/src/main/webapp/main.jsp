...
<body>
        ...
        <div class="container mt-3">
            ...
            <div id="play_list" class="card-body">
                <table class="table">
                    <tr>
                        <td>
                            <div class="imgBox"><img src="img/music.png" alt=""></div>
                        </td>
                        <td>
                            <div>노재제목</div>
                            <div>가수</div>
                        </td>
                        <td><button id="delete_btn" type="button" class="btn"><i class="fa-regular fa-trash-can"></i></button></td>
                    </tr>
                    <tr>
                        <td>
                            <div class="imgBox"><img src="img/music.png" alt=""></div>
    ...
    <nav>
        <div class="card-body nav-w">
            <div>
                <div class="row">
                    <div class="col-3"><i class="fa-solid fa-user"></i></div>
                    <div class="col-6">사용자 <i class="fa-solid fa-caret-down"></i></div>
                </div>
