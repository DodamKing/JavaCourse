...
<body>
        ...
        <div class="card-body nav-w">
            <div>
                <div class="row">
                    ...
                    <div class="col" id="dropMenu"><%=mnm %> <i class="fa-solid fa-caret-down"></i></div>
                </div>
                <%
                	if (mid == null) {
                %>
                <div class="list-group my-group">
                    <ul>
                        <li class="list-group-item list-group-item-light"><a href="login.jsp">로그인</a></li>
                        <li class="list-group-item list-group-item-light"><a href="signup.jsp">회원가입</a></li>
                        <li class="list-group-item list-group-item-light"><a href="bulletin.jsp">공지사항</a></li>
                    </ul>
                </div>
                <%
                } 
                ...
                <div class="list-group my-group">
                    <ul>
                        <li class="list-group-item list-group-item-light"><a href="mypage.jsp">My 멤버십</a></li>
                        <li class="list-group-item list-group-item-light"><a href="bulletin.jsp">공지사항</a></li>
                        <li class="list-group-item list-group-item-light"><a href="listpage.jsp">회원 조회</a></li>
                        <li class="list-group-item list-group-item-light"><a onclick="return confirm('로그아웃 하시겠습니까?')"  href="logout.jsp">로그아웃</a></li>
                    </ul>
                </div>
				<%              	
                	}
            ...
            <div>
                <ul>
                    ...
                    <li><a href="<%=request.getContextPath() %>/GetChart">차트</a></li>
                    <li><a href="">최신앨범</a></li>
    ...
    <footer>
        ...
        <div class="d-flex ml-4">
            <div class="pt-3">
                <div class="row">
                    <div id="controls_imgBox" class="imgBox"><img src="img/music.png" alt=""></div>
    ...
    <script src="js/player.js?ver=1"></script>
</body>
