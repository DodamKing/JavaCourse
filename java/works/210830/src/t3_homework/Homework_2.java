...
// (문제2) 100명 이하의 학생점수(국어/영어/수학)를 입력받아서 총점/평균/학점을 구하되, 출력은 총점 내림차순으로 출력하시오.
public class Homework_2 {
	public static void main(String[] args) {
		...
		System.out.println();
		for (int i=0; i<cnt; i++) System.out.printf("총점: %d, 평균: %.1f, 학점: %s\n", total[i], total[i]/3.0, grade_arr[i]);
